...
myDriver, myServer, myDatabase = ConnectToSQL.extractConnectionString()
myCursor, myConnection = ConnectToSQL.connectToDB(myDriver, myServer, myDatabase)
ConnectToSQL.returnTop100(myCursor, "dbo", "Merchants", "Name")
ConnectToSQL.disconnectFromDB(myConnection)